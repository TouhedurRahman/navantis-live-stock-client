const ExpiredReturnsInvoice = ({ firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, filteredExReturns }) => {
    ...
    const handlePrint = () => {
        ...
        <div>
            ...
            <div style="text-align: left; margin-bottom: 20px;">
                <h3 style="margin: 0; font-size: 18px; font-weight: bold; text-align: center;"><u>Expired Returns List</u></h3>
...
export default ExpiredReturnsInvoice;