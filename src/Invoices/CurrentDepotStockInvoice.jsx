const CurrentDepotStockInvoice = ({ invoiceWithAP, totalUnit, totalActualPrice, totalTradePrice, filteredProducts }) => {
    ...
    const handlePrint = () => {
        ...
        <div>
            ...
            <div style="text-align: left; margin-bottom: 20px;">
                <h3 style="margin: 0; font-size: 18px; font-weight: bold; text-align: center;"><u>Current Depot Stock</u></h3>
            </div>
    ...
    `;
        ...
        newWindow.document.write(`
            <html>
                <head>
                    <title>Current Depot Stock generated on ${today}</title>
                    ${styles}
                    <style>
                        @media print {
                            @page {
...
export default CurrentDepotStockInvoice;