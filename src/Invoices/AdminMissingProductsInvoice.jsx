const AdminMissingProductsInvoice = ({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts }) => {
    const accessAP = invoiceWithAP ?? false;

    const totalOrder = filteredProducts.reduce((sum, product) => sum + (product.orderQuantity), 0);
        ...
        const filteredTableContent = `
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: right;">Missing Quantity</th>
            ...
            (product, idx) => `
                            <tr>
                                ...
                                <td style="text-align: right;">${product.orderQuantity}</td>
                                <td style="text-align: right;">${product.missingQuantity}</td>
...
export default AdminMissingProductsInvoice;