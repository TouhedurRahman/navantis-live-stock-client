...
import AllProductsAchievementExcel from "../AllProductsAchievementExcel/AllProductsAchievementExcel";
import AllProductsAchievementReport from "../AllProductsAchievementReport/AllProductsAchievementReport";

const AllProductsAchievement = () => {
    ...
    const handlePrint = AllProductsAchievementReport({
        currentMonthsOrders,
    ...
    const handleDownloadExcel = AllProductsAchievementExcel({
        currentMonthsOrders,
        previousMonthsOrders,
        twoMonthsAgoOrders,
        twelveMonthsAgoOrders,
    ...
    return (
        <>
            <div>
                <PageTitle from={"Achievements"} to={"All products achievements"} />
            </div>
            <div className="bg-white pb-1">
                <div>
                    <h1 className="px-6 py-3 font-bold">All products target vs sales</h1>
...
export default AllProductsAchievement;