...
import FieldTerritoryWiseAchievementsExcel from "../FieldTerritoryWiseAchievementsExcel/FieldTerritoryWiseAchievementsExcel";
import FieldTerritoryWiseAchievementsReport from "../FieldTerritoryWiseAchievementsReport/FieldTerritoryWiseAchievementsReport";

const FieldTerritoryWiseAchievements = () => {
    ...
    const handlePrint = FieldTerritoryWiseAchievementsReport({
        currentMonthsOrders,
    ...
    const handleDownloadExcel = FieldTerritoryWiseAchievementsExcel({
        currentMonthsOrders,
        previousMonthsOrders,
        /* twoMonthsAgoOrders,
        twelveMonthsAgoOrders, */
...
export default FieldTerritoryWiseAchievements;