...
const PlaceDrReqOrder = () => {
    ...
    return (
        <>
            <PageTitle from={"Doctor requisition"} to={"Place order"} />
            <div className="bg-white">
                <h1 className="px-6 py-3 font-bold">Make doctor wise Order</h1>
...
export default PlaceDrReqOrder;