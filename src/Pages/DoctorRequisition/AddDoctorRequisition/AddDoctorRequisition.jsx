...
const AddDoctorRequisition = () => {
    ...
    const addNewCustomerMutation = useMutation({
        mutationFn: async (data) => {
            const newCustomer = {
                name: data.name,
                territory: data.territory || "Doctor",
                parentTerritory: "Doctor",
                parentId: "Doctor",
                grandParentId: "Doctor",
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                        <div className="flex flex-col">
                            ...
                            <input
                                ...
                                defaultValue={"Doctor Requisition"}
                                readOnly
                            />
...
export default AddDoctorRequisition;