...
const DepotExpiredProduct = () => {
    ...
    const handlePrintWithAP = DepotExpiredInvoice({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });

    const handlePrint = DepotExpiredInvoice({ firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });
...
export default DepotExpiredProduct;