...
import useStockOutDepot from "../../../Hooks/useStockOutDepot";
import DepotStockOutInvoice from "../../../Invoices/DepotStockOutInvoice";

const DepotStockOutList = () => {
    const [singleUser] = useSingleUser();

    const invoiceWithAP = 1;

    const [products, loading] = useStockOutDepot();
    ...
    const handlePrintWithAP = DepotStockOutInvoice({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });

    const handlePrint = DepotStockOutInvoice({ firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });
    ...
    return (
        <div>
            ...
            <div className="bg-white pb-1">
                <div>
                    <h1 className="px-6 py-3 font-bold">Depot stock out products list</h1>
...
export default DepotStockOutList;