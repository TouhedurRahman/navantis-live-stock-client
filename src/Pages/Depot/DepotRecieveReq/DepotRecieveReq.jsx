    ...
    return (
        <>
            <div>
                <PageTitle
                    from={"Depot"}
                    to={"Request to receive"}
                />
            </div>
            <div className="bg-white pb-1">
                <div>
                    <h1 className="px-6 py-3 font-bold">Receive request list</h1>
                    ...
                    loading
                        ...
                        <>
                            ...
                            <div className="m-6 p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow-md">
                                <p className="text-md text-gray-700 text-center mb-4 font-medium">Pending Receive Request Summary</p>
...
export default DepotRecieveReq;