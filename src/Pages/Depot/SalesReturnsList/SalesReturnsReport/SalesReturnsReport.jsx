...
const SalesReturnsReport = ({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts }) => {
    ...
    const handlePrint = () => {
        ...
        <div>
            ...
            <div style="text-align: left; margin-bottom: 20px;">
                <h3 style="margin: 0; font-size: 18px; font-weight: bold; text-align: center;"><u>Sales Returns List</u></h3>
    ...
    `;
        ...
        newWindow.document.write(`
            <html>
                <head>
                    <title>Sales Returns List generated on ${today}</title>
                    ${styles}
                    <style>
                        @media print {
                            @page {
