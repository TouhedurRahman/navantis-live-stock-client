...
import DoctorRequestCard from "../DoctorRequestCard/DoctorRequestCard";
            ...
            <div className="bg-white pb-1">
                {
                    ...
                    &&
                    <div>
                        <h1 className="px-6 py-3 font-bold">Request to approve doctor(s)</h1>
