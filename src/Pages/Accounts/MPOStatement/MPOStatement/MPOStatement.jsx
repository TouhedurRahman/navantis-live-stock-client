                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-6 px-6">
                        ...
                        <div className='col-span-1 md:col-span-2'>
                            ...
                            <select
                                ...
                                className="border border-gray-300 rounded-lg w-full px-3 py-2 focus:outline-none bg-white shadow-sm cursor-pointer"
                            >
                                <option value="MPO Statement">MPO Statement</option>
                                {
                                    territory !== ''
                                    &&
                                    < option value="Territory wise MPO Statement">Territory wise MPO Statement</option>
                                }
                                {
                                    orderedBy !== ''
                                    &&
                                    < option value="MPO wise Statement">MPO wise Statement</option>
                                }
                                {
                                    areaManager !== ''
                                    &&
                                    < option value="Area Manager wise MPO Statement">Area Manager wise MPO Statement</option>
                                }
                                {
                                    customer !== ''
                                    &&
                                    <option value="Customer wise MPO Statement">Customer wise MPO Statement</option>
                                }
                            </select>
                        </div>
