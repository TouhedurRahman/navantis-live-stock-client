...
const DueListReportExcel = ({ reportType, filteredOrders = [], firstDate, lastDate, customerCode, customerName, customerAddress, customerMobile }) => {
                ...
                const mpoSections = Object.entries(mpoData)
                    .map(([mpoName, pharmacies]) => {
                        ...
                        const rows = pharmacies.map((pharmacy) => {
                            ...
                            return `
                        <tr>
                            <td style="padding: 8px; border: 1px solid #ccc;  width: 8%;  text-align: left;">${pharmacy.pharmacyId}</td>
