                        ...
                        <div className='col-span-1 md:col-span-2'>
                            ...
                            >
                                <option value="Due Payments">Due Payments</option>
                                {
                                    orderedBy !== ''
                                    &&
                                    < option value="MPO wise Due Payments">MPO wise Due Payments</option>
                                }
                                {
                                    areaManager !== ''
                                    &&
                                    < option value="Area Manager wise Due Payments">Area Manager wise Due Payments</option>
                                }
                                {
                                    customer !== ''
                                    &&
                                    <option value="Customer wise Due Payments">Customer wise Due Payments</option>
                                }
                            </select>
                        </div>
