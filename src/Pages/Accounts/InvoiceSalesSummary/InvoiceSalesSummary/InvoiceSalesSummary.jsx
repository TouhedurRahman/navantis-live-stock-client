                                ...
                                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-6 px-6">
                                    ...
                                    <div className='col-span-1 md:col-span-2'>
                                        ...
                                        <Select
                                            ...
                                            onChange={(e) => setReportType(e?.value || 'Invoice Sales Summary')}
                                            options={[
                                                { value: "Invoice Sales Summary", label: "Invoice Sales Summary" },
                                                ...(orderedBy ? [{ value: "MPO wise Invoice Sales Summary", label: "MPO wise Invoice Sales Summary" }] : []),
                                                ...(territory ? [{ value: "Territory wise Invoice Sales Summary", label: "Territory wise Invoice Sales Summary" }] : []),
                                                ...(areaManager ? [{ value: "Area Manager wise Invoice Sales Summary", label: "Area Manager wise Invoice Sales Summary" }] : []),
                                                ...(customer ? [{ value: "Customer wise Invoice Sales Summary", label: "Customer wise Invoice Sales Summary" }] : [])
                                            ]}
                                            isClearable
                                            isSearchable
                                        />
