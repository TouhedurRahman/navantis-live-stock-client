...
import CustomerRequest from "../../Customer/CustomerRequest/CustomerRequest";
...
const Customer = () => {
    ...
    return (
        <>
            <div>
                <PageTitle from={"Admin"} to={"Customer list"} />
            </div>
                ...
                <div className="h-10 flex justify-between items-center p-6">
                    <div className="flex flex-wrap justify-start items-center space-x-4">
                        {[
                            ...
                            { label: "Customer Request", value: "customer request", color: "bg-red-500", hover: "hover:bg-red-700" }
                        ].map((button) => (
                            <button
                                key={button.value}
