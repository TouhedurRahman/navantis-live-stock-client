...
import MyDoctor from "../../Doctor/DoctorList/MyDoctor/MyDoctor";
import DoctorRequest from "../../Doctor/DoctorRequest/DoctorRequest/DoctorRequest";
...
const Doctor = () => {
    ...
    return (
        <>
            <div>
                <PageTitle from={"Admin"} to={"Doctor list"} />
            </div>
                ...
                <div className="h-10 flex justify-between items-center p-6">
                    <div className="flex flex-wrap justify-start items-center space-x-4">
                        {[
                            ...
                            { label: "Doctor Request", value: "doctor request", color: "bg-red-500", hover: "hover:bg-red-700" }
                        ].map((button) => (
                            <button
                                key={button.value}
