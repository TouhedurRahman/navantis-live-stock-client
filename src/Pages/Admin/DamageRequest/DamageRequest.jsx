...
import DamageRequestProductCard from "../DamageRequestProductCard/DamageRequestProductCard";

const DamageRequest = () => {
    const [products, loading, refetch] = useDamagedProductsWh();
                                    ...
                                    <table className="table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th className='text-center'>Damage Quantity</th>
