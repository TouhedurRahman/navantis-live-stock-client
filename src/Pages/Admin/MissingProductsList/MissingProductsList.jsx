...
const MissingProductsList = () => {
    ...
    const [products, loading] = useStockReq();
    ...
    const handlePrintWithAP = AdminMissingProductsInvoice({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });

    const handlePrint = AdminMissingProductsInvoice({ firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });
...
export default MissingProductsList;