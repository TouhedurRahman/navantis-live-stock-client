...
const AdminDamagedExpiredList = () => {
    ...
    const [products, loading] = useDamagedExpired();
    ...
    const handlePrintWithAP = AdminDamagedExpiredInvoice({ invoiceWithAP, firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });

    const handlePrint = AdminDamagedExpiredInvoice({ firstDate, lastDate, totalUniqueProducts, totalUnit, totalTP, totalAP, filteredProducts });
    ...
    return (
        <div>
            ...
            <div className="bg-white pb-1">
                <div>
                    <h1 className="px-6 py-3 font-bold">Damaged & Expired products list</h1>
...
export default AdminDamagedExpiredList;