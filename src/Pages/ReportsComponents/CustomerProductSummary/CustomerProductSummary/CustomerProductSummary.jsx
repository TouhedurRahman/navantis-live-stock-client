                                ...
                                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-6 px-6">
                                    ...
                                    <div className='col-span-1 md:col-span-2'>
                                        ...
                                        <Select
                                            ...
                                            onChange={(e) => setReportType(e?.value || "Customer's Products Summary")}
                                            options={[
                                                { value: "Customer's Products Summary", label: "Customer's Products Summary" },
                                                ...(productKey ? [{ value: "Product wise Customer's Products Summary", label: "Product wise Customer's Products Summary" }] : []),
                                                ...(orderedBy ? [{ value: "MPO wise Customer's Products Summary", label: "MPO wise Customer's Products Summary" }] : []),
                                                ...(territory ? [{ value: "Territory wise Customer's Products Summary", label: "Territory wise Customer's Products Summary" }] : []),
                                                ...(areaManager ? [{ value: "Area Manager wise Customer's Products Summary", label: "Area Manager wise Customer's Products Summary" }] : []),
                                                ...(customer ? [{ value: "Customer wise Customer's Products Summary", label: "Customer wise Customer's Products Summary" }] : [])
                                            ]}
                                            isClearable
                                            isSearchable
                                        />
