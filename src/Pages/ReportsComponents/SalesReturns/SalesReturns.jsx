...
const SalesReturns = () => {
    ...
    const [reportType, setReportType] = useState('Sales Returns');
    ...
    const clearFilters = () => {
        ...
        setAreaManager('');
        setCustomer('');
        setReportType('Sales Returns');
    };

    const handlePrint = SalesReturnsReport({
        reportType,
        filteredReturns,
        firstDate,
        lastDate,
    ...
    const handleDownloadExcel = SalesReturnsReportExcel({
        reportType,
        filteredReturns,
        firstDate,
        lastDate,
    ...
    return (
        <>
            <div>
                <PageTitle from={"Reports"} to={"Sales returns"} />
            </div>
