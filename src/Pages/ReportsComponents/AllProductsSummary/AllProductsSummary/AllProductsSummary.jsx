...
import AllProductsSummaryExcel from "../AllProductsSummaryExcel/AllProductsSummaryExcel";
import AllProductsSummaryReport from "../AllProductsSummaryReport/AllProductsSummaryReport";
...
const AllProductsSummary = () => {
    ...
    const [reportType, setReportType] = useState('Products Summary All');
    ...
    const clearFilters = () => {
        ...
        setAreaManager('');
        setCustomer('');
        setReportType('Products Summary All');
    };

    const handlePrint = AllProductsSummaryReport({
        reportType,
        filteredOrders,
        firstDate,
        lastDate,
    ...
    const handleDownloadExcel = AllProductsSummaryExcel({
        reportType,
        filteredOrders,
        firstDate,
        lastDate,
    ...
    return (
        <>
            <div>
                <PageTitle from={"Reports"} to={"Products summary all"} />
            </div>
            <div className="bg-white pb-1">
                <div>
                    <h1 className="px-6 py-3 font-bold">All products summary report</h1>
                                    ...
                                    <div className='col-span-1 md:col-span-2'>
                                        ...
                                        <Select
                                            ...
                                            options={[
                                                ...
                                                ...(orderedBy ? [{ value: "MPO wise Products Summary All", label: "MPO wise Products Summary All" }] : []),
                                                ...(territory ? [{ value: "Territory wise Products Summary All", label: "Territory wise Products Summary All" }] : []),
                                                ...(areaManager ? [{ value: "Area Manager wise Products Summary All", label: "Area Manager wise Products Summary All" }] : []),
                                                ...(customer ? [{ value: "Customer wise Products Summary All", label: "Customer wise Products Summary All" }] : [])
                                            ]}
                                            isClearable
                                            isSearchable
                                        />
...
export default AllProductsSummary;