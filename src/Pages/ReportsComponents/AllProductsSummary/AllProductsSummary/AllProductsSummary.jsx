                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-6 px-6">
                        ...
                        <div className='col-span-1 md:col-span-2'>
                            ...
                            <select
                                ...
                                className="border border-gray-300 rounded-lg w-full px-3 py-2 focus:outline-none bg-white shadow-sm cursor-pointer"
                            >
                                <option value="Products Summary All">Products Summary All</option>
                                {
                                    orderedBy !== ''
                                    &&
                                    < option value="MPO wise Products Summary All">MPO wise Products Summary All</option>
                                }
                                {
                                    areaManager !== ''
                                    &&
                                    < option value="Area Manager wise Products Summary All">Area Manager wise Products Summary All</option>
                                }
                                {
                                    customer !== ''
                                    &&
                                    <option value="Customer wise Products Summary All">Customer wise Products Summary All</option>
                                }
                            </select>
                        </div>
