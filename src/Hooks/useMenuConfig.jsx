    ...
    const menuOptions = {
        ...
        depot: {
            ...
            links: [
                ...
                { to: '/depot-receive', icon: <FaArrowDown className='me-2' />, label: 'Receive' },
                { to: '/depot-sales-returns', icon: <FaArrowDown className='me-2' />, label: 'Sales Returns' },
        ...
        doctorRequisition: {
            ...
            links: [
                ...
                { to: '/dr-req-order', icon: <FaCartPlus className='me-2' />, label: 'Place Dr. Req. Order' },
            ],
        },
        customer: {
        ...
        reports: {
            ...
            links: [
                ...
                { to: '/product-summary-all', icon: <TbReportAnalytics className='me-2' />, label: 'Product Summary All' },
                { to: '/customer-product-summary', icon: <TbReportAnalytics className='me-2' />, label: 'Product Summary Customer' },
